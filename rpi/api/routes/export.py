...
from api.settings import TILES_DIR, TILES_PATH, PARENT_TEMP_DIR


router = APIRouter()


@router.get("/info/{profile}/{zoom}/{x_min}/{y_min}/{x_max}/{y_max}")
...
@router.get("/pdf/{profile}/{zoom}/{x_min}/{y_min}/{x_max}/{y_max}")
