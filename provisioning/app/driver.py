...
for bc_resource_road_file in bc_resource_road_files:
    for class_name in ("bc-resource-roads", "bc-resource-roads-label"):
        layers.extend([ProjectLayer(path=bc_resource_road_file, style_class=class_name, crs_code=bc_resource_roads_crs_code, type=bc_resource_roads_output_type)])
