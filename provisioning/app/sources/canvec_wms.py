...
def provision(bbox: BBOX, scales: Tuple[int]) -> None:
    wms_provisioner(bbox, "https://maps.geogratis.gc.ca/wms/canvec_en", "EPSG:3857", ("canvec",), tuple(), scales, "png", get_output_path(CACHE_DIR_NAME))
