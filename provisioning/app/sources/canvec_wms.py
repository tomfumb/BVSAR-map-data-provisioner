...
from provisioning.app.sources.common.wms import provision as wms_provisioner, OUTPUT_TYPE as WMS_OUTPUT_TYPE, WmsProperties
...
def provision(bbox: BBOX, scales: Tuple[int], run_id: str) -> Dict[int, List[str]]:
    return wms_provisioner(bbox, "https://maps.geogratis.gc.ca/wms/canvec_en", WmsProperties(max_width=4096, max_height=4096), OUTPUT_CRS_CODE, ("canvec",), tuple(), scales, "png", CACHE_DIR_NAME, run_id)
